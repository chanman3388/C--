...
class Sales_item {
  // these declarations are explained in section 7.2.1, p. 270
 ...
 public:
  ...
  // member binary operator: left-hand operator bound to implicit this pointer
...
std::istream& operator>>(std::istream& in, Sales_item& s)
{
  ...
  if (in)
    ...
    s = Sales_item(); // input failed: reset object to default trace
  return in;
}
